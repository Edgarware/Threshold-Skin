"steam/cached/SettingsSubInterface.res"
{
	...
	layout{
		...
		place { controls=DPIScalingCheck,AutoLaunchCheck,BigPictureModeCheck,UrlBarCheck,GPUWebViewCheck,SmoothScrollWebViewCheck,DWriteCheck,H264HWAccelCheck start=SkinCombo dir=down margin-top=8 spacing=0}
