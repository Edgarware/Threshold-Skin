...
IF /I "%Sidebar%"=="c" (
    ...
    mklink /H .\resource\layout\uistatuspanel.layout ".\Customization\Sidebar Width\Collapsed Sidebar\resource\layout\uinavigatorpanel.layout"
    goto ApplyAvatar
) ELSE (
    ...
    mklink /H .\resource\layout\uistatuspanel.layout ".\Customization\Sidebar Width\Expanded Sidebar\resource\layout\uinavigatorpanel.layout"
)
:ApplyAccount
IF /I "%Account%"=="h" (
...
echo. >> .\config.ini
echo //Here lie options. They are few. >> .\config.ini
echo. >> .\config.ini
